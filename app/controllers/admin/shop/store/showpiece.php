...
class showpiece_controller extends FS_controller {
    ...
    public function hot()
    {
        ...
        $data['global']['shop_hot_showpiece'] = $shop_hot_showpiece_Setting->value_Str;
    ...
    public function hot_post()
    {
            ...
            $shop_hot_showpiece = $this->input->post('shop_hot_showpiece', TRUE);

            $SettingList = new SettingList();
            $SettingList->construct([
                'construct_Arr' => [
                    [
                        'keyword_Str' => 'shop_hot_showpiece',
                        'value_Str' => $shop_hot_showpiece,
                        'modelname_Str' => 'showpiece/list'
                    ]
                ]
            ]);
            $SettingList->update();
            ...
            $this->Message->show(array(
                'message' => '設定成功',
                'url' => 'admin/shop/store/showpiece/hot'
            ));
    }
